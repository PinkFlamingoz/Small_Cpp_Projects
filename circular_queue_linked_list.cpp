...
class Circular_queue
{
	...
	// • Set the rear's next pointer to the new node
	// • Move the rear pointer to the newly-created node
	// • Move the new nodes's next pointer to the front
	...
	// • Free the front of the list
	// • Move the front pointer to the (former) second element
	// • Make the rear pointer point to the front
	void dequeue()
	{
		if (is_empty())
		{
